...
namespace SuryavanshiLibraryManagmentSyatem.Controllers
{
    public class PublishersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Phone,Email,Notes")] Publisher publisher)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Phone,Email,Notes")] Publisher publisher)
        {
            if (id != publisher.Id)
            {
                return NotFound();
